...
function rcdoc_html_classes() {
    ...
    attr_trumps( array(
        'body'                        => 'u-bg-cover',
        'site_container'              => 'mdl-layout mdl-js-layout u-bg-frost-2',
        'site_container_loggedin'        => 'mdl-layout mdl-js-layout u-bg-frost-2',
        ...
        // SITE HEADER
        'header'                      => 'u-bg-1-dark u-bg-cover u-bg-fixed u-bg-no-repeat u-bg-center u-text-white mdl-layout__header mdl-layout__header--scroll',
        'branding'                    => 'u-mr3 u-px3 u-px1@md u-py2 u-inline-block u-color-inherit mdl-layout__header-row',
        'site_title'                  => 'mdl-layout-title u-color-inherit u-m0 u-h1 u-z4',
        ...
        // FOOTER
        'footer'                      => 'u-bg-1-light u-border-t u-text-white u-color-inherit mdl-mega-footer',
